          ...
          <div className={styles.track__titleImage}>
            ...
            {/* <svg
              className={classNames(styles.track__titleSvg, {
                [styles.active]: isActive && !isPlay,
                [styles.pulse]: isActive && isPlay,
              })}
            >
            ...
            {/* <svg
              className={classNames(styles.track__titleSvg, {
                [styles.active]: isActive && !isPlay, // фиолетовая точка, когда пауза
                [styles.pulse]: isActive && isPlay, // пульсация, когда играет
              })}
              viewBox="0 0 10 10"
